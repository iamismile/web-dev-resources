...
- [Tura](https://github.com/Tura-AI/tura) - Local, open-source coding agent for terminal-based repository work with configurable cloud and local model providers.
